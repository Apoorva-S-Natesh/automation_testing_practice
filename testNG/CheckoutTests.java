...
public class CheckoutTests {
	...
	@BeforeSuite (groups = "smoke") //If groups for these methods are not provided then they wont be executed
	...
	@Test
	(priority = 4, enabled=false) // test is disabled, its not executed and ignored in testNG report
